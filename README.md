...
Como fazer: Clique [aqui](https://github.com/assismauro/CursoPython/archive/master.zip). Se não der certo, clique no botão verde **Clone or Download** acima, à direita. Selecione a opção **Download ZIP**. Ele vai baixar um arquivo chamado CursoPython-master.zip. Cope esse conteúdo para o diretório **CursoPython\\Aulas**.
